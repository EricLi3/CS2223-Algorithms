...
public class Analysis {
	...
	public static long numPow;
	public static long numPower;
	/**
	...
	static long model(int n) {
		...
		double firstTerm = 2 * Math.pow(2, log2n) - 2;
	    double secondTerm = 3 * n;
	    double thirdTerm = (n * log2n) / 2;
	...
	public static void main(String[] args) {
		...
		for (int n = 2; n <= 1024; n *= 2) {
			...
			System.out.println(String.format("%6d %20d %20d %20d", n, val, numPow, model(n)));
		}
	}
}
